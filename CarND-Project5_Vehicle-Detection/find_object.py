...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 22 08:47:03 2017
...
def find_cars(img, box_list, ystart, ystop, scale, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins):
    ...
    nxblocks = (ch1.shape[1] // pix_per_cell)-1 # No of Cells on X
    nyblocks = (ch1.shape[0] // pix_per_cell)-1 # No of Cells on Y
    nfeat_per_block = orient*cell_per_block**2
    # 64 was the orginal sampling rate, with 8 cells and 8 pix per cell
    window = 64
    nblocks_per_window = (window // pix_per_cell)-1 
    #nblocks_per_window = 64
...
def find_car(img):
    dist_pickle = pickle.load( open("svc_pickle_lin_YCrCb.p", "rb" ) )
    svc = dist_pickle["svc"]
    ...
    heat = apply_threshold(heat,15) #25
